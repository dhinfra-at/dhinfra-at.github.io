...
Each document carries its version and date. An editorial change raises the patch version
and needs no approval. A material change, one that alters what users may do, must do or
can expect, raises the minor version, is approved as the Governance Concept sets out, and
is announced with an effective date. From 1.0 on, each document carries a changelog and

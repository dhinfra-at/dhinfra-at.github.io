...
<div class="grid gap-4 sm:grid-cols-3 not-prose my-6">
  <img src="/images/posts/2025-08-28-graz-gpu-cluster-install/unpacking.jpg" alt="Unpacking the server components" class="rounded-md w-full" />
  <img src="/images/posts/2025-08-28-graz-gpu-cluster-install/cable-mgmt.jpg" alt="Cable management in the server rack" class="rounded-md w-full" />
  <img src="/images/posts/2025-08-28-graz-gpu-cluster-install/memtest-pass.jpg" alt="Successful memory test on the new hardware" class="rounded-md w-full" />
</div>
...
We will prioritize institutions with [ACOnet](https://www.aco.net/) access, enabling seamless registration via single sign-on (SSO).
